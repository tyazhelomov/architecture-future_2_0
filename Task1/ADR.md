...
**Must**
1. Обновление DWH на более современный и производительный Apache Iceberg, который даст бизнесу быструю аналитику, меньше времени на выгрузки и отчёты и улучшение доступности данных для аналитиков.
...
2. Замена Apache Camel на Kafka+Airflow для высокой отказоустойчивости и масштабируемости
